...
func DeleteApplicationCallbackHandler() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := Utils.Validate(DeleteApplicationCallbackRequest); err != nil {
		...
		if err := Application.DeleteApplicationCallbackService(DeleteApplicationCallbackRequest); err != nil {
